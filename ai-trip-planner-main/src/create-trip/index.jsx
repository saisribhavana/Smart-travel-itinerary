...
function CreateTrip() {
    ...
    const OnGenerateTrip = async () => {
        ...
        if (!formData?.location || !formData?.noOfDays || !formData?.sourceLocation || !formData?.traveler || !formData?.budget) {
                ...
                <div>
                    ...
                    <GooglePlacesAutocomplete
                        ...
                        selectProps={{
                            ...
                            onChange: (v) => {
                                setPlace(v);
                                handleInputChange("sourceLocation", v);
                            },
                        }}
                    />
                </div>
                        ...
                        <DialogDescription>
                            <div className="flex justify-end">
                                <AiOutlineClose
                                    ...
                                    onClick={() => setOpenDailog(false)} // Close the dialog when clicked
                                />
                            </div>
